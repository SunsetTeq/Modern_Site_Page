...
export const MainPage = () => {
  ...
  return (
    <div className="flex-1">
      ...
      <div className="mt-[-35px] grid overflow-hidden rounded-3xl md:mt-[9px] xl:mt-[-70px]">
        <div className="bg-accent3 h-[362px] w-full self-end rounded-3xl [grid-area:1/1]" />
        <img
          src={isMobile ? mobileIphone : desktopIpad}
          alt="Dashboard preview"
          className={`z-10 -mx-px block justify-self-center [grid-area:1/1] ${!isMobile ? 'translate-y-20 md:w-[min(720px,92vw)] xl:w-[min(947px,92vw)] xl:translate-y-40' : 'w-[min(270px,92vw)] translate-y-25'} object-cover object-center`}
        />
      </div>
      <TrustedBy />
      <Benefits />
